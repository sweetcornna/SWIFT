...
from swift.experiments.ppo_training_runner import PPOTrainingRunConfig, run_ppo_training_smoke  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run a CPU PPO+MLP Stage 1 training smoke.")
    ...
    if args.dry_run:
        print(f"SWIFT PPO MLP smoke config OK: {args.config}")
        return 0

    result = run_ppo_training_smoke(
    ...
    print(f"SWIFT PPO MLP smoke written: {args.output}")
